...
const i18nTexts = {
  ...
  'fr-FR': {
    ...
    timeFormat: {
      ...
      onJustNow: 'à l\'instant',
      onSecondsAgo: 'il y a {n} secondes',
      onMinutesAgo: 'il y a {n} minutes',
      onHoursAgo: 'il y a {n} heures',
  ...
  'de-DE': {
    ...
    timeFormat: {
      ...
      onJustNow: 'gerade eben',
      onSecondsAgo: 'vor {n} Sekunden',
      onMinutesAgo: 'vor {n} Minuten',
      onHoursAgo: 'vor {n} Stunden',
      onDayAgo: 'vor {n} Tag',
  ...
  'es-ES': {
    ...
    timeFormat: {
      ...
      onJustNow: 'justo ahora',
      onSecondsAgo: 'hace {n} segundos',
      onMinutesAgo: 'hace {n} minutos',
      onHoursAgo: 'hace {n} horas',
      onDayAgo: 'hace {n} día',
  ...
  'ru-RU': {
    ...
    timeFormat: {
      ...
      onJustNow: 'только что',
      onSecondsAgo: '{n} секунд назад',
      onMinutesAgo: '{n} минут назад',
      onHoursAgo: '{n} часов назад',
